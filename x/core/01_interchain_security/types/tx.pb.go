...
type MsgAnnounceValidator struct {
	...
	// mailbox_id ...
	MailboxId github_com_dymensionxyz_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,4,opt,name=mailbox_id,json=mailboxId,proto3,customtype=github.com/dymensionxyz/hyperlane-cosmos/util.HexAddress" json:"mailbox_id"`
	// creator ...
...
type MsgSetRoutingIsmDomain struct {
	// ism_id ...
	IsmId github_com_dymensionxyz_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,1,opt,name=ism_id,json=ismId,proto3,customtype=github.com/dymensionxyz/hyperlane-cosmos/util.HexAddress" json:"ism_id"`
	// route ...
...
var fileDescriptor_4ee100bdd8d27ecb = []byte{
	...
	,
}
