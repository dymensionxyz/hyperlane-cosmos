...
type EventCreateMessageIdMultisigIsmRaw struct {
	IsmId      github_com_bcp_innovations_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,1,opt,name=ism_id,json=ismId,proto3,customtype=github.com/bcp-innovations/hyperlane-cosmos/util.HexAddress" json:"ism_id"`
	Owner      string                                                      `protobuf:"bytes,2,opt,name=owner,proto3" json:"owner,omitempty"`
	Validators []string                                                    `protobuf:"bytes,3,rep,name=validators,proto3" json:"validators,omitempty"`
	Threshold  uint32                                                      `protobuf:"varint,4,opt,name=threshold,proto3" json:"threshold,omitempty"`
...
func (m *EventCreateMessageIdMultisigIsmRaw) Reset()         { *m = EventCreateMessageIdMultisigIsmRaw{} }
func (m *EventCreateMessageIdMultisigIsmRaw) String() string { return proto.CompactTextString(m) }
func (*EventCreateMessageIdMultisigIsmRaw) ProtoMessage()    {}
func (*EventCreateMessageIdMultisigIsmRaw) Descriptor() ([]byte, []int) {
	return fileDescriptor_d9752d6bb2f92366, []int{3}
}
func (m *EventCreateMessageIdMultisigIsmRaw) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventCreateMessageIdMultisigIsmRaw) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventCreateMessageIdMultisigIsmRaw.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventCreateMessageIdMultisigIsmRaw) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventCreateMessageIdMultisigIsmRaw.Merge(m, src)
}
func (m *EventCreateMessageIdMultisigIsmRaw) XXX_Size() int {
	return m.Size()
}
func (m *EventCreateMessageIdMultisigIsmRaw) XXX_DiscardUnknown() {
	xxx_messageInfo_EventCreateMessageIdMultisigIsmRaw.DiscardUnknown(m)
}

var xxx_messageInfo_EventCreateMessageIdMultisigIsmRaw proto.InternalMessageInfo

func (m *EventCreateMessageIdMultisigIsmRaw) GetOwner() string {
	if m != nil {
		return m.Owner
	}
	return ""
...
func (m *EventCreateMessageIdMultisigIsmRaw) GetValidators() []string {
	if m != nil {
		return m.Validators
	}
	return nil
...
func (m *EventCreateMessageIdMultisigIsmRaw) GetThreshold() uint32 {
	if m != nil {
		return m.Threshold
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*EventCreateMessageIdMultisigIsmRaw)(nil), "hyperlane.core.interchain_security.v1.EventCreateMessageIdMultisigIsmRaw")
...
var fileDescriptor_d9752d6bb2f92366 = []byte{
	...
	,
}
...
func (m *EventCreateMessageIdMultisigIsmRaw) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventCreateMessageIdMultisigIsmRaw) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventCreateMessageIdMultisigIsmRaw) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventCreateMessageIdMultisigIsmRaw) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventCreateMessageIdMultisigIsmRaw) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventCreateMessageIdMultisigIsmRaw: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventCreateMessageIdMultisigIsmRaw: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
